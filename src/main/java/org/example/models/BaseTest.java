...
public class BaseTest {
    ...
    public void setUp() {
        ...
        clearBrowserLocalStorage(); //Не убрал очистку локальной истории, так как браузер
        // сохраняет добавленные в корзину товары, из-за чего тесты отрабатывают некорректно
